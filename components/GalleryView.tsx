          ...
          <button
            ...
            className={`px-5 py-2 rounded-full text-sm font-semibold transition-all ${
              active === f.id
                ...
                : "bg-[#fafaf8] text-[#3d3a35] border border-[#e4e0da] hover:border-gold hover:text-gold"
            }`}
          >
            {f.label}
          </button>
        ...
        <AnimatePresence>
          {visible.map((item, i) => (
            <motion.div
              ...
              className="group cursor-pointer rounded-2xl overflow-hidden border border-[#e4e0da] shadow-sm hover:shadow-xl transition-shadow"
            >
              ...
              <div className="p-4 bg-[#fafaf8]">
                <div className="font-bold text-[#2c2a27] text-[15px]">{item.title}</div>
          ...
          >
            ...
            >
              ...
              <div className="p-6 flex items-start justify-between gap-4">
                ...
                <button onClick={() => setLightbox(null)} className="p-2 rounded-full bg-[#fafaf8]/10 hover:bg-[#fafaf8]/20 text-white">
                  <X className="w-5 h-5" />
                </button>
              </div>
            </motion.div>
