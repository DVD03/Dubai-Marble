      ...
      <AnimatePresence>
        {show && (
          <motion.div
            ...
            className="bg-[#111827] border border-white/20 text-white text-xs p-4 rounded-2xl shadow-2xl max-w-[220px] relative"
          >
            <button
            ...
            <div className="font-bold text-[#FF8C00] mb-1 text-sm">Quick Response</div>
