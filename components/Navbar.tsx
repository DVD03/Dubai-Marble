          ...
          <Link href="/" className="flex items-center gap-3 group shrink-0">
            ...
            <div>
              <div className="text-white font-extrabold text-[17px] leading-tight tracking-tight flex items-center gap-1.5">
                ...
                <Sparkles className="w-3.5 h-3.5 text-gold hidden sm:inline" />
              </div>
              <div className="text-gold text-[11px] font-semibold tracking-wide">
                تلميع الرخام دبي &bull; Luxury Stone Care
              </div>
            </div>
          </Link>
