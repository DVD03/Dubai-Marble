        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            <AnimatedSection>
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-[#2c2a27] mb-4">{service.title} — Dubai</h2>
              <p className="text-[#6b6560] leading-relaxed mb-8">{service.description}</p>

              <h3 className="text-xl font-black text-[#2c2a27] mb-4">Key Benefits</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-10">
                {service.benefits.map((b) => (
                  <div key={b} className="flex items-start gap-2.5 text-sm text-[#3d3a35]">
              ...
              <h3 className="text-xl font-black text-[#2c2a27] mb-6">Our 4-Step Professional Process</h3>
                ...
                <div className="flex flex-col gap-6">
                  {service.process.map((step, idx) => (
                    <div key={step.step} className="flex gap-5">
                      ...
                      <div className="bg-[#f0ede8] border border-[#e4e0da] rounded-xl p-5 flex-grow">
                        <div className="font-bold text-[#2c2a27] text-sm mb-1">{step.title}</div>
                        <p className="text-xs text-[#8a8278] leading-relaxed">{step.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="mt-10 p-6 rounded-2xl bg-[#f0ede8] border-l-4 border-gold">
                <h4 className="font-bold text-[#2c2a27] text-base mb-1">Book a Free On-Site Inspection · حجز معاينة مجانية</h4>
                ...
                <Link href="/booking" className="bg-[#4a6fa5] hover:bg-[#3b5a8a] text-white font-bold text-xs px-6 py-3 rounded-lg shadow-sm inline-flex items-center gap-2 transition-colors">
          ...
          <div className="lg:col-span-4 flex flex-col gap-7">
            <AnimatedSection direction="right">
              <div className="bg-[#f0ede8] border border-[#e4e0da] rounded-2xl p-6">
                <h3 className="font-black text-[#2c2a27] text-base mb-4 pb-3 border-b border-[#e4e0da] flex justify-between items-center">
                    ...
                    <Link key={s.slug} href={`/services/${s.slug}`}
                      className={`flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-semibold transition-colors ${
                        s.slug === service.slug
                          ...
                          : "bg-[#fafaf8] text-[#6b6560] hover:bg-[#ede9e3] hover:text-gold"
                      }`}>
              ...
              <div className="relative rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-dark/85 flex flex-col justify-end p-6">
                  ...
                  <a href="tel:+971508164087"
                    className="bg-[#4a6fa5] hover:bg-[#3b5a8a] text-white font-bold text-xs py-3 rounded-lg shadow-sm w-full flex items-center justify-center gap-2 mb-2 transition-colors">
