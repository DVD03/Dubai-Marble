          ...
          <div className="lg:col-span-8">
            <AnimatedSection>
              ...
              <div className="mt-10 p-6 rounded-2xl bg-[#f8f7f4] border-l-4 border-gold">
                ...
                <Link href="/booking" className="brand-gradient text-white font-bold text-xs px-6 py-3 rounded-xl shadow inline-flex items-center gap-2 hover:shadow-gold/30 transition-all">
                  ...
                  {servicesData.map((s) => (
                    <Link key={s.slug} href={`/services/${s.slug}`}
                      className={`flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-semibold transition-colors ${
                        s.slug === service.slug
                          ? "brand-gradient text-white shadow font-bold"
              ...
              <div className="relative rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-dark/85 flex flex-col justify-end p-6">
                  ...
                  <a href="tel:+971508164087"
                    className="brand-gradient text-white font-bold text-xs py-3 rounded-xl shadow w-full flex items-center justify-center gap-2 mb-2 hover:shadow-gold/30 transition-all">
